...
public class BookshelvesDB {
    ...
    private static final BookshelvesDB bookshelvesDB = new BookshelvesDB();
    private final ConcurrentHashMap<BigInteger, BookshelfExt> bookshelfExtById;
    ...
    public static synchronized BigInteger getNextId() throws Exception {
        lastId += 1;
        return BigInteger.valueOf(lastId - 1);
    }
