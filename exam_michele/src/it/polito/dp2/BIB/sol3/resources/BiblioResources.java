...
public class BiblioResources {
	...
	@Produces({MediaType.APPLICATION_XML,MediaType.APPLICATION_JSON})
	public Item getItem(
			@ApiParam("The id of the item") @PathParam("id") BigInteger id) throws NotFoundException, Exception{
		Item item;
		try {
	...
	public Item updateItem(
			...
			Item item)throws BadRequestException, NotFoundException, Exception {
    ...
    @ApiResponses(value = {
    		...
    		@ApiResponse(code = 404, message = "Not Found"),
    		@ApiResponse(code = 409, message = "Conflict (The items  is cited by one or more  other items)"),
    		})
	...
	public Response createItemCitation(
			@ApiParam("The id of the citing item of this citation") @PathParam("id") BigInteger id,
			@ApiParam("The id of the cited item of this citation") @PathParam("tid") BigInteger tid,
			Citation citation) throws BadRequestException, NotFoundException, ClientErrorException, Exception {
