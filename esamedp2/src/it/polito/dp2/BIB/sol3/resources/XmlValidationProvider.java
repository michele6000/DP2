  ...
  public XmlValidationProvider() {
    ...
    try {
      InputStream schemaStream =
        XmlValidationProvider.class.getResourceAsStream("/xsd/biblio.xsd");
      ...
      InputStream templateStream =
        XmlValidationProvider.class.getResourceAsStream(
      ...
      logger.log(
        Level.SEVERE,
        "Error initializing XmlProvider. Service will not work properly.",
        e
      );
    }
  }
  ...
  public T readFrom(
    ...
    try {
      ...
      try {
        ...
        if (obj.getClass().equals(type)) return (T) obj; else {
          logger.log(
            Level.WARNING,
            "Request body validation error. Wrong Type."
          );
        ...
        if (
          linked != null && linked instanceof SAXParseException
