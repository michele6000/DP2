...
public class BiblioResources {
  ...
  public Items getItems(
    ...
    @ApiParam("The year before which items are searched") @QueryParam(
      "beforeInclusive"
    ) @DefaultValue("10000") int beforeInclusive,
    @ApiParam("The year after which items are searched") @QueryParam(
      "afterInclusive"
    ) @DefaultValue("0") int afterInclusive,
    @ApiParam("The page of results to be read") @QueryParam(
      "page"
    ) @DefaultValue("1") int page
  )
    throws BadRequestException, Exception {
    if (keyword == null) throw new BadRequestException("keyword is required");
    try {
  ...
  @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
  public Response createItem(Item item) throws BadRequestException, Exception {
    if (item == null) throw new BadRequestException();

    try {
      Item returnItem = service.createItem(item);
      return Response
        .created(new URI(returnItem.getSelf()))
        .entity(returnItem)
        .build();
    } catch (Exception e1) {
      throw new InternalServerErrorException();
  ...
  @ApiResponses(
    value = {
      ...
      @ApiResponse(
        code = 409,
        message = "Conflict (The items  is cited by one or more  other items)"
      ),
    }
  )
  public void deleteItem(
    ...
    throws NotFoundException, ClientErrorException, Exception {
    BigInteger ret;
    try {
  ...
  @ApiOperation(
    value = "getItemCitedBy",
    notes = "read the items citing an item"
  )
  @ApiResponses(
    value = {
      @ApiResponse(code = 200, message = "OK", response = Items.class),
  ...
  public Items getItemCitedBy(
    @ApiParam(
      "The id of the item for which citing items have to be read"
  ...
  @ApiOperation(
    value = "getItemCitations",
    notes = "read the target items of the citations from an item"
  )
  @ApiResponses(
    value = {
      @ApiResponse(code = 200, message = "OK", response = Items.class),
  ...
  public Items getItemCitations(
    @ApiParam(
      "The id of the item from which citations are considered"
    ) @PathParam("id") BigInteger id
  )
    throws NotFoundException, Exception {
    Items items;
  ...
  public Citation getItemCitation(
    @ApiParam("The id of the citing item of this citation") @PathParam(
      "id"
    ) BigInteger id,
    @ApiParam("The id of the cited item of this citation") @PathParam(
      "tid"
    ) BigInteger tid
  )
    throws NotFoundException, Exception {
    ...
    if (citation == null) throw new NotFoundException();
    return citation;
  }
  ...
  @Path("/items/{id}/citations/{tid}")
  @ApiOperation(
    value = "createItemCitation",
    notes = "create a citation",
    response = Citation.class
  )
  @ApiResponses(
    value = {
  ...
  public Response createItemCitation(
    ...
    throws BadRequestException, NotFoundException, ClientErrorException, Exception {
    if (citation == null) throw new BadRequestException();
    ...
    if (!u.equals(u2)) throw new BadRequestException();
    ...
    if (newCitation == null) throw new NotFoundException();
